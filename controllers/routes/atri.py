...
class Atri:
	def __init__(self, state: Any):
		...
		self.navbar.w-nav = state["navbar.w-nav"]
		self.wrapper.nav = state["wrapper.nav"]
		self.Flex90 = state["Flex90"]
		self.Div332 = state["Div332"]
		...
		self.home-hero-section.wf-section = state["home-hero-section.wf-section"]
		self.home-hero-section.flex = state["home-hero-section.flex"]
		self.home-hero-content-wrapper = state["home-hero-content-wrapper"]
		self.home-hero-heading-wrapper = state["home-hero-heading-wrapper"]
		self.Div34 = state["Div34"]
		self.trusted-by-section_wf_section = state["trusted-by-section_wf_section"]
		self.trusted-by-section.wflex = state["trusted-by-section.wflex"]
		self.Flex12 = state["Flex12"]
		self.Services = state["Services"]
		self.service-heading-and-subtext-wrapper = state["service-heading-and-subtext-wrapper"]
		self.Div41 = state["Div41"]
		self.services_grid_flex_fix = state["services_grid_flex_fix"]
		self.Div43 = state["Div43"]
		self.service_wrapper_1 = state["service_wrapper_1"]
		self.service-pointer-wrapper = state["service-pointer-wrapper"]
		self.service-pointer-wrapper_flex = state["service-pointer-wrapper_flex"]
		...
		self.case-studies-section.wf-section = state["case-studies-section.wf-section"]
		self.studies-section.wf-section_>_div.wrapper.case-studies-heading = state["studies-section.wf-section_>_div.wrapper.case-studies-heading"]
		self.case-studies-section.wf-section_>_div.wrapper.case-studies-heading = state["case-studies-section.wf-section_>_div.wrapper.case-studies-heading"]
		self.Div78 = state["Div78"]
		self.Div79 = state["Div79"]
		self.wrapper.project-slider = state["wrapper.project-slider"]
		self.case-studies-section.wf-section_>_div.wrapper.project-slider_>_div = state["case-studies-section.wf-section_>_div.wrapper.project-slider_>_div"]
		self.w-slider-mask-0 = state["w-slider-mask-0"]
		...
		self.blog-section.wf-section = state["blog-section.wf-section"]
		self.blog-section.wf-section_>_div = state["blog-section.wf-section_>_div"]
		self.blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper = state["blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper"]
		self.Div105 = state["Div105"]
		self.div.blog-content-wrapper = state["div.blog-content-wrapper"]
		...
		self.lets_talk = state["lets_talk"]
		...
		self.Div328 = state["Div328"]
		self.Div331 = state["Div331"]
		...
		self.trusted-by-text-wrapper = state["trusted-by-text-wrapper"]
		...
		self.service-pointer-trigger-text-wrapper_ = state["service-pointer-trigger-text-wrapper_"]
	...
	@property
	def navbar.w-nav(self):
		self._getter_access_tracker["navbar.w-nav"] = {}
		return self._navbar.w-nav
	@navbar.w-nav.setter
	def navbar.w-nav(self, new_state):
		self._setter_access_tracker["navbar.w-nav"] = {}
		global default_state
		self._navbar.w-nav = Div(new_state, default_state["navbar.w-nav"])

	@property
	def wrapper.nav(self):
		self._getter_access_tracker["wrapper.nav"] = {}
		return self._wrapper.nav
	@wrapper.nav.setter
	def wrapper.nav(self, new_state):
		self._setter_access_tracker["wrapper.nav"] = {}
		global default_state
		self._wrapper.nav = Flex(new_state, default_state["wrapper.nav"])
	...
	@property
	def Div332(self):
		self._getter_access_tracker["Div332"] = {}
		return self._Div332
	@Div332.setter
	def Div332(self, new_state):
		self._setter_access_tracker["Div332"] = {}
		global default_state
		self._Div332 = Div(new_state, default_state["Div332"])
	...
	@property
	def home-hero-section.wf-section(self):
		self._getter_access_tracker["home-hero-section.wf-section"] = {}
		return self._home-hero-section.wf-section
	@home-hero-section.wf-section.setter
	def home-hero-section.wf-section(self, new_state):
		self._setter_access_tracker["home-hero-section.wf-section"] = {}
		global default_state
		self._home-hero-section.wf-section = Div(new_state, default_state["home-hero-section.wf-section"])

	@property
	def home-hero-section.flex(self):
		self._getter_access_tracker["home-hero-section.flex"] = {}
		return self._home-hero-section.flex
	@home-hero-section.flex.setter
	def home-hero-section.flex(self, new_state):
		self._setter_access_tracker["home-hero-section.flex"] = {}
		global default_state
		self._home-hero-section.flex = Flex(new_state, default_state["home-hero-section.flex"])

	@property
	def home-hero-content-wrapper(self):
		self._getter_access_tracker["home-hero-content-wrapper"] = {}
		return self._home-hero-content-wrapper
	@home-hero-content-wrapper.setter
	def home-hero-content-wrapper(self, new_state):
		self._setter_access_tracker["home-hero-content-wrapper"] = {}
		global default_state
		self._home-hero-content-wrapper = Div(new_state, default_state["home-hero-content-wrapper"])

	@property
	def home-hero-heading-wrapper(self):
		self._getter_access_tracker["home-hero-heading-wrapper"] = {}
		return self._home-hero-heading-wrapper
	@home-hero-heading-wrapper.setter
	def home-hero-heading-wrapper(self, new_state):
		self._setter_access_tracker["home-hero-heading-wrapper"] = {}
		global default_state
		self._home-hero-heading-wrapper = Div(new_state, default_state["home-hero-heading-wrapper"])
	...
	@property
	def trusted-by-section_wf_section(self):
		self._getter_access_tracker["trusted-by-section_wf_section"] = {}
		return self._trusted-by-section_wf_section
	@trusted-by-section_wf_section.setter
	def trusted-by-section_wf_section(self, new_state):
		self._setter_access_tracker["trusted-by-section_wf_section"] = {}
		global default_state
		self._trusted-by-section_wf_section = Div(new_state, default_state["trusted-by-section_wf_section"])

	@property
	def trusted-by-section.wflex(self):
		self._getter_access_tracker["trusted-by-section.wflex"] = {}
		return self._trusted-by-section.wflex
	@trusted-by-section.wflex.setter
	def trusted-by-section.wflex(self, new_state):
		self._setter_access_tracker["trusted-by-section.wflex"] = {}
		global default_state
		self._trusted-by-section.wflex = Div(new_state, default_state["trusted-by-section.wflex"])
	...
	@property
	def service-heading-and-subtext-wrapper(self):
		self._getter_access_tracker["service-heading-and-subtext-wrapper"] = {}
		return self._service-heading-and-subtext-wrapper
	@service-heading-and-subtext-wrapper.setter
	def service-heading-and-subtext-wrapper(self, new_state):
		self._setter_access_tracker["service-heading-and-subtext-wrapper"] = {}
		global default_state
		self._service-heading-and-subtext-wrapper = Div(new_state, default_state["service-heading-and-subtext-wrapper"])
	...
	@property
	def services_grid_flex_fix(self):
		self._getter_access_tracker["services_grid_flex_fix"] = {}
		return self._services_grid_flex_fix
	@services_grid_flex_fix.setter
	def services_grid_flex_fix(self, new_state):
		self._setter_access_tracker["services_grid_flex_fix"] = {}
		global default_state
		self._services_grid_flex_fix = Flex(new_state, default_state["services_grid_flex_fix"])
	...
	@property
	def service_wrapper_1(self):
		self._getter_access_tracker["service_wrapper_1"] = {}
		return self._service_wrapper_1
	@service_wrapper_1.setter
	def service_wrapper_1(self, new_state):
		self._setter_access_tracker["service_wrapper_1"] = {}
		global default_state
		self._service_wrapper_1 = Div(new_state, default_state["service_wrapper_1"])

	@property
	def service-pointer-wrapper(self):
		self._getter_access_tracker["service-pointer-wrapper"] = {}
		return self._service-pointer-wrapper
	@service-pointer-wrapper.setter
	def service-pointer-wrapper(self, new_state):
		self._setter_access_tracker["service-pointer-wrapper"] = {}
		global default_state
		self._service-pointer-wrapper = Div(new_state, default_state["service-pointer-wrapper"])

	@property
	def service-pointer-wrapper_flex(self):
		self._getter_access_tracker["service-pointer-wrapper_flex"] = {}
		return self._service-pointer-wrapper_flex
	@service-pointer-wrapper_flex.setter
	def service-pointer-wrapper_flex(self, new_state):
		self._setter_access_tracker["service-pointer-wrapper_flex"] = {}
		global default_state
		self._service-pointer-wrapper_flex = Flex(new_state, default_state["service-pointer-wrapper_flex"])
	...
	@property
	def case-studies-section.wf-section(self):
		self._getter_access_tracker["case-studies-section.wf-section"] = {}
		return self._case-studies-section.wf-section
	@case-studies-section.wf-section.setter
	def case-studies-section.wf-section(self, new_state):
		self._setter_access_tracker["case-studies-section.wf-section"] = {}
		global default_state
		self._case-studies-section.wf-section = Div(new_state, default_state["case-studies-section.wf-section"])

	@property
	def studies-section.wf-section_>_div.wrapper.case-studies-heading(self):
		self._getter_access_tracker["studies-section.wf-section_>_div.wrapper.case-studies-heading"] = {}
		return self._studies-section.wf-section_>_div.wrapper.case-studies-heading
	@studies-section.wf-section_>_div.wrapper.case-studies-heading.setter
	def studies-section.wf-section_>_div.wrapper.case-studies-heading(self, new_state):
		self._setter_access_tracker["studies-section.wf-section_>_div.wrapper.case-studies-heading"] = {}
		global default_state
		self._studies-section.wf-section_>_div.wrapper.case-studies-heading = Flex(new_state, default_state["studies-section.wf-section_>_div.wrapper.case-studies-heading"])

	@property
	def case-studies-section.wf-section_>_div.wrapper.case-studies-heading(self):
		self._getter_access_tracker["case-studies-section.wf-section_>_div.wrapper.case-studies-heading"] = {}
		return self._case-studies-section.wf-section_>_div.wrapper.case-studies-heading
	@case-studies-section.wf-section_>_div.wrapper.case-studies-heading.setter
	def case-studies-section.wf-section_>_div.wrapper.case-studies-heading(self, new_state):
		self._setter_access_tracker["case-studies-section.wf-section_>_div.wrapper.case-studies-heading"] = {}
		global default_state
		self._case-studies-section.wf-section_>_div.wrapper.case-studies-heading = Div(new_state, default_state["case-studies-section.wf-section_>_div.wrapper.case-studies-heading"])
	...
	@property
	def wrapper.project-slider(self):
		self._getter_access_tracker["wrapper.project-slider"] = {}
		return self._wrapper.project-slider
	@wrapper.project-slider.setter
	def wrapper.project-slider(self, new_state):
		self._setter_access_tracker["wrapper.project-slider"] = {}
		global default_state
		self._wrapper.project-slider = Flex(new_state, default_state["wrapper.project-slider"])

	@property
	def case-studies-section.wf-section_>_div.wrapper.project-slider_>_div(self):
		self._getter_access_tracker["case-studies-section.wf-section_>_div.wrapper.project-slider_>_div"] = {}
		return self._case-studies-section.wf-section_>_div.wrapper.project-slider_>_div
	@case-studies-section.wf-section_>_div.wrapper.project-slider_>_div.setter
	def case-studies-section.wf-section_>_div.wrapper.project-slider_>_div(self, new_state):
		self._setter_access_tracker["case-studies-section.wf-section_>_div.wrapper.project-slider_>_div"] = {}
		global default_state
		self._case-studies-section.wf-section_>_div.wrapper.project-slider_>_div = Flex(new_state, default_state["case-studies-section.wf-section_>_div.wrapper.project-slider_>_div"])

	@property
	def w-slider-mask-0(self):
		self._getter_access_tracker["w-slider-mask-0"] = {}
		return self._w-slider-mask-0
	@w-slider-mask-0.setter
	def w-slider-mask-0(self, new_state):
		self._setter_access_tracker["w-slider-mask-0"] = {}
		global default_state
		self._w-slider-mask-0 = Div(new_state, default_state["w-slider-mask-0"])
	...
	@property
	def blog-section.wf-section(self):
		self._getter_access_tracker["blog-section.wf-section"] = {}
		return self._blog-section.wf-section
	@blog-section.wf-section.setter
	def blog-section.wf-section(self, new_state):
		self._setter_access_tracker["blog-section.wf-section"] = {}
		global default_state
		self._blog-section.wf-section = Div(new_state, default_state["blog-section.wf-section"])

	@property
	def blog-section.wf-section_>_div(self):
		self._getter_access_tracker["blog-section.wf-section_>_div"] = {}
		return self._blog-section.wf-section_>_div
	@blog-section.wf-section_>_div.setter
	def blog-section.wf-section_>_div(self, new_state):
		self._setter_access_tracker["blog-section.wf-section_>_div"] = {}
		global default_state
		self._blog-section.wf-section_>_div = Flex(new_state, default_state["blog-section.wf-section_>_div"])

	@property
	def blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper(self):
		self._getter_access_tracker["blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper"] = {}
		return self._blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper
	@blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper.setter
	def blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper(self, new_state):
		self._setter_access_tracker["blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper"] = {}
		global default_state
		self._blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper = Div(new_state, default_state["blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper"])
	...
	@property
	def div.blog-content-wrapper(self):
		self._getter_access_tracker["div.blog-content-wrapper"] = {}
		return self._div.blog-content-wrapper
	@div.blog-content-wrapper.setter
	def div.blog-content-wrapper(self, new_state):
		self._setter_access_tracker["div.blog-content-wrapper"] = {}
		global default_state
		self._div.blog-content-wrapper = Div(new_state, default_state["div.blog-content-wrapper"])
	...
	@property
	def lets_talk(self):
		self._getter_access_tracker["lets_talk"] = {}
		return self._lets_talk
	@lets_talk.setter
	def lets_talk(self, new_state):
		self._setter_access_tracker["lets_talk"] = {}
		global default_state
		self._lets_talk = Div(new_state, default_state["lets_talk"])
	...
	@property
	def Div328(self):
		self._getter_access_tracker["Div328"] = {}
		return self._Div328
	@Div328.setter
	def Div328(self, new_state):
		self._setter_access_tracker["Div328"] = {}
		global default_state
		self._Div328 = Div(new_state, default_state["Div328"])

	@property
	def Div331(self):
		self._getter_access_tracker["Div331"] = {}
		return self._Div331
	@Div331.setter
	def Div331(self, new_state):
		self._setter_access_tracker["Div331"] = {}
		global default_state
		self._Div331 = Div(new_state, default_state["Div331"])
	...
	@property
	def trusted-by-text-wrapper(self):
		self._getter_access_tracker["trusted-by-text-wrapper"] = {}
		return self._trusted-by-text-wrapper
	@trusted-by-text-wrapper.setter
	def trusted-by-text-wrapper(self, new_state):
		self._setter_access_tracker["trusted-by-text-wrapper"] = {}
		global default_state
		self._trusted-by-text-wrapper = TextBox(new_state, default_state["trusted-by-text-wrapper"])
	...
	@property
	def service-pointer-trigger-text-wrapper_(self):
		self._getter_access_tracker["service-pointer-trigger-text-wrapper_"] = {}
		return self._service-pointer-trigger-text-wrapper_
	@service-pointer-trigger-text-wrapper_.setter
	def service-pointer-trigger-text-wrapper_(self, new_state):
		self._setter_access_tracker["service-pointer-trigger-text-wrapper_"] = {}
		global default_state
		self._service-pointer-trigger-text-wrapper_ = TextBox(new_state, default_state["service-pointer-trigger-text-wrapper_"])
	...
	@property
	def Icon12(self):
		self._getter_access_tracker["Icon12"] = {}
		return self._Icon12
	@Icon12.setter
	def Icon12(self, new_state):
		self._setter_access_tracker["Icon12"] = {}
		global default_state
		self._Icon12 = Icon(new_state, default_state["Icon12"])
	...
	def _to_json_fields(self):
		return {
			"body": self._body,
			"navbar.w-nav": self._navbar.w-nav,
			"wrapper.nav": self._wrapper.nav,
			"Flex90": self._Flex90,
			"Div332": self._Div332,
			"Flex91": self._Flex91,
			"Div338": self._Div338,
			...
			"Div336": self._Div336,
			"Div334": self._Div334,
			"home-hero-section.wf-section": self._home-hero-section.wf-section,
			"home-hero-section.flex": self._home-hero-section.flex,
			"home-hero-content-wrapper": self._home-hero-content-wrapper,
			"home-hero-heading-wrapper": self._home-hero-heading-wrapper,
			"Div34": self._Div34,
			"trusted-by-section_wf_section": self._trusted-by-section_wf_section,
			"trusted-by-section.wflex": self._trusted-by-section.wflex,
			"Flex12": self._Flex12,
			"Services": self._Services,
			"service-heading-and-subtext-wrapper": self._service-heading-and-subtext-wrapper,
			"Div41": self._Div41,
			"services_grid_flex_fix": self._services_grid_flex_fix,
			"Div43": self._Div43,
			"service_wrapper_1": self._service_wrapper_1,
			"service-pointer-wrapper": self._service-pointer-wrapper,
			"service-pointer-wrapper_flex": self._service-pointer-wrapper_flex,
			"Flex20": self._Flex20,
			"Flex21": self._Flex21,
			"Div64": self._Div64,
			"Div62": self._Div62,
			...
			"Flex33": self._Flex33,
			"Flex34": self._Flex34,
			"case-studies-section.wf-section": self._case-studies-section.wf-section,
			"studies-section.wf-section_>_div.wrapper.case-studies-heading": self._studies-section.wf-section_>_div.wrapper.case-studies-heading,
			"case-studies-section.wf-section_>_div.wrapper.case-studies-heading": self._case-studies-section.wf-section_>_div.wrapper.case-studies-heading,
			"Div78": self._Div78,
			"Div79": self._Div79,
			"wrapper.project-slider": self._wrapper.project-slider,
			"case-studies-section.wf-section_>_div.wrapper.project-slider_>_div": self._case-studies-section.wf-section_>_div.wrapper.project-slider_>_div,
			"w-slider-mask-0": self._w-slider-mask-0,
			"Div84": self._Div84,
			"Div88": self._Div88,
			"Div97": self._Div97,
			"Div96": self._Div96,
			...
			"Div99": self._Div99,
			"Div98": self._Div98,
			"blog-section.wf-section": self._blog-section.wf-section,
			"blog-section.wf-section_>_div": self._blog-section.wf-section_>_div,
			"blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper": self._blog-section.wf-section_>_div_>_div.blog-heading-and-subtext-wrapper,
			"Div105": self._Div105,
			"div.blog-content-wrapper": self._div.blog-content-wrapper,
			"Div107": self._Div107,
			"Div108": self._Div108,
			"Div110": self._Div110,
			"Div112": self._Div112,
			...
			"Icon4": self._Icon4,
			"Link26": self._Link26,
			"trusted-by-text-wrapper": self._trusted-by-text-wrapper,
			"Image8": self._Image8,
			"Image9": self._Image9,
			...
			"service-pointer-trigger-text-wrapper_": self._service-pointer-trigger-text-wrapper_,
